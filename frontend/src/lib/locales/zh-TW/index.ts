...
export const zhTW = {
  ...
  podcasts: {
    audiobookScriptProfile: "腳本模型（設定檔）",
    audiobookVoiceProfile: "語音（設定檔）",
    audiobookRetry: "重試",
    audiobookFailed: "失敗",
    audiobookGenerate: "產生有聲書",
    audiobookGenerateTitle: "產生有聲書",
    audiobookGenerateDesc: "選擇已匯入的書籍（來源）並開始按章節產生音訊。",
    audiobookSourceLabel: "書籍（來源）",
    audiobookNameLabel: "有聲書名稱",
    audiobookGenerateStart: "開始產生",
    ...
    importBook: "新增書籍",
    importBookTitle: "新增書籍（PDF）",
    importBookDesc: "上傳掃描書籍PDF，自動進行OCR轉換（支援直排日文）、圖片說明與向量化（400頁約30分鐘）。",
    importBookFile: "PDF檔案",
    importBookName: "書名（選填）",
    importBookCaptions: "產生圖片說明（vision）",
    importBookStart: "開始匯入",
    importBookRunning: "轉換與匯入中… 關閉此頁面後伺服器仍會繼續處理。",
    importBookDone: "匯入完成。可用於搜尋、諮詢與有聲書產生。",
    importBookError: "匯入失敗",
    playerSeek: "進度",
    playerBack10: "後退10秒",
    playerForward10: "前進10秒",
    playerSpeed: "播放速度",
    playerVolume: "音量",
    ...
    audiobookFigures: "圖表",
    audiobookAudioPending: "產生中",
    audiobookSelectChapter: "請選擇要播放的章節",
    audiobookPrevChapter: "上一章",
    audiobookNextChapter: "下一章",
    audiobookPlay: "播放",
    audiobookPause: "暫停",
  ...
  mentor: {
    title: "向導師請教",
    subtitle: "與讀遍你整個書庫的導師討論資料、工作方式與職涯發展。",
    placeholder: "輸入你的問題…（⌘Enter 送出）",
    send: "送出",
    thinking: "思考中…",
    memoryButton: "記憶",
    memoryTitle: "過往諮詢",
    memoryEmpty: "還沒有記憶。每次諮詢後導師會記住要點。",
    memoryDelete: "刪除記憶",
    memoryDeleteError: "刪除記憶失敗",
    retry: "重試",
    speak: "朗讀",
    speakError: "產生語音失敗",
    consultError: "導師無法回答，請再試一次。",
    sampleQuestion1: "想討論客戶提案的結構",
    sampleQuestion2: "如何傳達一份難以啟齒的進度報告？",
    sampleQuestion3: "未來半年我應該重點提升什麼？",
    tabChat: "諮詢",
    tabSlides: "簡報",
    tabWeights: "學習權重",
    weightSaved: "權重已儲存",
    weightSaveError: "儲存權重失敗",
    weightsEmpty: "書庫為空。請先匯入書籍。",
    weightsHelp: "調整導師參考每本書的程度（0 為排除）。×N 徽章是依近期諮詢自動加權的結果。",
    weightBook: "書籍權重",
    weightChapter: "章節權重",
    weightChapters: "章節權重",
    weightExcluded: "已從檢索中排除",
    weightAutoHint: "依近期諮詢的自動加權",
    slideDropzone: "上傳要點評的簡報（png / jpg / pdf / pptx）",
    slideReviewing: "導師正在點評你的簡報…",
    slideReviewError: "簡報點評失敗，請重試。",
    slideHistory: "歷史點評",
    gatePassed: "通過品質門檻",
    gateFailed: "未達品質門檻（{{threshold}}）",
    topFix: "優先修改",
    axis_logic: "邏輯與論點結構",
    axis_message_body: "標題與內文一致性",
    axis_charts: "表格與圖表",
    axis_tone_manner: "風格統一",
    axis_design: "設計",
    applySelect: "選擇要套用的修改",
    ...
    personaSave: "儲存",
    personaActivate: "切換到此角色",
    personaActivated: "已切換角色",
    personaSaved: "角色已儲存",
    personaError: "儲存角色失敗",
  },
