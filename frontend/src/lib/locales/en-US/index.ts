export const enUS = {
  ...
  podcasts: {
    audiobookScriptProfile: "Script model (profile)",
    audiobookVoiceProfile: "Voice (profile)",
    ...
    audiobookGenerateDesc: "Pick an ingested book (Source) and start per-chapter audio generation.",
    audiobookSourceLabel: "Book (Source)",
    audiobookNameLabel: "Audiobook name",
    audiobookGenerateStart: "Start generation",
    ...
    importBook: "Add a book",
    importBookTitle: "Add a book (PDF)",
    importBookDesc: "Upload a scanned book PDF. It is converted with OCR (vertical Japanese supported) and ingested with figure captions and embeddings - about 30 min for 400 pages.",
    importBookFile: "PDF file",
    importBookName: "Book title (optional)",
    importBookCaptions: "Generate figure captions (vision)",
    importBookStart: "Start import",
    importBookRunning: "Converting and ingesting... you can close this page; progress continues on the server.",
    importBookDone: "Book imported. It is now searchable and ready for audiobook generation.",
    importBookError: "Import failed",
    playerSeek: "Seek",
    playerBack10: "Back 10 seconds",
    ...
    audiobookFigures: "Figures & charts",
    audiobookAudioPending: "Generating",
    audiobookSelectChapter: "Select a chapter to play",
    audiobookPrevChapter: "Previous chapter",
    audiobookNextChapter: "Next chapter",
    audiobookPlay: "Play",
  ...
  mentor: {
    title: "Consult your Mentor",
    subtitle: "Talk through your documents, work, and career with a mentor who has read your entire library.",
    placeholder: "Ask your mentor… (⌘Enter to send)",
    send: "Send",
    thinking: "Thinking…",
    memoryButton: "Memories",
    memoryTitle: "Past consultations",
    memoryEmpty: "No memories yet. Your mentor remembers the gist of each consultation.",
    memoryDelete: "Delete memory",
    memoryDeleteError: "Failed to delete memory",
    retry: "Retry",
    speak: "Read aloud",
    speakError: "Failed to generate audio",
    consultError: "The mentor could not answer. Please try again.",
    sampleQuestion1: "I'd like feedback on the structure of my client proposal",
    sampleQuestion2: "How should I deliver a difficult progress report?",
    sampleQuestion3: "What should I focus on to grow over the next six months?",
    tabChat: "Consult",
    tabSlides: "Slides",
    tabWeights: "Learning weights",
    weightSaved: "Weight saved",
    weightSaveError: "Failed to save weight",
    weightsEmpty: "No books yet. Ingest a book first.",
    weightsHelp: "Adjust how heavily the mentor draws on each book (0 excludes it). The ×N badge is the automatic boost from recent consultations.",
    weightBook: "Book weight",
    weightChapter: "Chapter weight",
    weightChapters: "Chapter weights",
    weightExcluded: "Excluded from recall",
    weightAutoHint: "Automatic boost from recent consultations",
    slideDropzone: "Drop a slide deck to review (png / jpg / pdf / pptx)",
    slideReviewing: "The mentor is reviewing your slides…",
    slideReviewError: "Slide review failed. Please try again.",
    slideHistory: "Past reviews",
    gatePassed: "Quality gate passed",
    gateFailed: "Below quality gate ({{threshold}})",
    topFix: "Fix this first",
    axis_logic: "Logic & argument structure",
    axis_message_body: "Message–body alignment",
    axis_charts: "Tables & charts",
    axis_tone_manner: "Tone & manner",
    axis_design: "Design",
    applySelect: "Select fix to apply",
    ...
    personaSave: "Save",
    personaActivate: "Switch to this persona",
    personaActivated: "Persona switched",
