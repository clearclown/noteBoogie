...
export const esES = {
  ...
  podcasts: {
    ...
    audiobookGenerateTitle: "Generar un audiolibro",
    audiobookGenerateDesc: "Elige un libro importado (fuente) e inicia la generación de audio por capítulo.",
    audiobookSourceLabel: "Libro (fuente)",
    audiobookNameLabel: "Nombre del audiolibro",
    audiobookGenerateStart: "Iniciar generación",
    audiobookGenerateError: "No se pudo iniciar la generación. ¿Está el gateway en ejecución?",
    audiobooksTab: "Audiolibros",
    audiobooksEmpty: "Aún no hay audiolibros. Convierte un libro y genera uno con `make ingest-book`.",
    chapterFeedbackUp: "Buen capítulo",
    chapterFeedbackDown: "Capítulo flojo",
    importBook: "Añadir libro",
    importBookTitle: "Añadir libro (PDF)",
    importBookDesc: "Sube el PDF de un libro escaneado: OCR (japones vertical incluido), leyendas de figuras y embeddings - ~30 min por 400 paginas.",
    importBookFile: "Archivo PDF",
    importBookName: "Titulo (opcional)",
    importBookCaptions: "Generar leyendas de figuras (vision)",
    importBookStart: "Iniciar importacion",
    importBookRunning: "Convirtiendo e ingiriendo... puedes cerrar; el servidor continua.",
    importBookDone: "Libro importado. Listo para busqueda y audiolibro.",
    importBookError: "Fallo la importacion",
    playerSeek: "Posicion",
    playerBack10: "Retroceder 10 segundos",
    playerForward10: "Avanzar 10 segundos",
    playerSpeed: "Velocidad de reproduccion",
    playerVolume: "Volumen",
    audiobookChapters: "Capítulos",
    audiobookChapterCount: "{{count}} capítulos",
    audiobookAutoAdvance: "Avance automático",
    audiobookFigures: "Figuras y gráficos",
    audiobookAudioPending: "Generando",
    audiobookSelectChapter: "Selecciona un capítulo para reproducir",
    audiobookPrevChapter: "Capítulo anterior",
    audiobookNextChapter: "Capítulo siguiente",
    audiobookPlay: "Reproducir",
  ...
  mentor: {
    title: "Consulta a tu mentor",
    subtitle: "Habla de tus documentos, trabajo y carrera con un mentor que ha leído toda tu biblioteca.",
    placeholder: "Pregunta a tu mentor… (⌘Intro para enviar)",
    send: "Enviar",
    thinking: "Pensando…",
    memoryButton: "Memorias",
    memoryTitle: "Consultas anteriores",
    memoryEmpty: "Aún no hay memorias. El mentor recuerda lo esencial de cada consulta.",
    memoryDelete: "Eliminar memoria",
    memoryDeleteError: "No se pudo eliminar la memoria",
    retry: "Reintentar",
    speak: "Leer en voz alta",
    speakError: "No se pudo generar el audio",
    consultError: "El mentor no pudo responder. Inténtalo de nuevo.",
    sampleQuestion1: "Quiero revisar la estructura de mi propuesta para el cliente",
    sampleQuestion2: "¿Cómo comunico un informe de progreso difícil?",
    sampleQuestion3: "¿En qué debería centrarme para crecer en los próximos seis meses?",
    tabChat: "Consultar",
    tabSlides: "Diapositivas",
    tabWeights: "Pesos de aprendizaje",
    weightSaved: "Peso guardado",
    weightSaveError: "No se pudo guardar el peso",
    weightsEmpty: "Aún no hay libros. Importa un libro primero.",
    weightsHelp: "Ajusta cuánto se apoya el mentor en cada libro (0 lo excluye). La insignia ×N es el refuerzo automático de las consultas recientes.",
    weightBook: "Peso del libro",
    weightChapter: "Peso del capítulo",
    weightChapters: "Pesos de los capítulos",
    weightExcluded: "Excluido de la búsqueda",
    weightAutoHint: "Refuerzo automático de las consultas recientes",
    slideDropzone: "Sube un deck para revisar (png / jpg / pdf / pptx)",
    slideReviewing: "El mentor está revisando tus diapositivas…",
    slideReviewError: "La revisión falló. Inténtalo de nuevo.",
    slideHistory: "Revisiones anteriores",
    gatePassed: "Umbral de calidad superado",
    gateFailed: "Por debajo del umbral de calidad ({{threshold}})",
    topFix: "Corrige esto primero",
    axis_logic: "Lógica y estructura argumental",
    axis_message_body: "Coherencia mensaje–cuerpo",
    axis_charts: "Tablas y gráficos",
    axis_tone_manner: "Tono y coherencia",
    axis_design: "Diseño",
    applySelect: "Seleccionar corrección",
    applyFixes: "Aplicar {{count}} correcciones y descargar",
    applyDone: "Deck corregido descargado",
    ...
    personaSave: "Guardar",
    personaActivate: "Cambiar a esta persona",
    personaActivated: "Persona cambiada",
