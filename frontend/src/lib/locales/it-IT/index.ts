...
export const itIT = {
  ...
  podcasts: {
    ...
    audiobookGenerateTitle: "Genera un audiolibro",
    audiobookGenerateDesc: "Scegli un libro importato (fonte) e avvia la generazione audio per capitolo.",
    audiobookSourceLabel: "Libro (fonte)",
    audiobookNameLabel: "Nome dell'audiolibro",
    audiobookGenerateStart: "Avvia generazione",
    ...
    importBook: "Aggiungi libro",
    importBookTitle: "Aggiungi libro (PDF)",
    importBookDesc: "Carica il PDF di un libro scansionato: OCR (giapponese verticale supportato), didascalie delle figure ed embedding - ~30 min per 400 pagine.",
    importBookFile: "File PDF",
    importBookName: "Titolo (opzionale)",
    importBookCaptions: "Genera didascalie figure (vision)",
    importBookStart: "Avvia importazione",
    importBookRunning: "Conversione e ingestione... puoi chiudere; il server continua.",
    importBookDone: "Libro importato. Pronto per ricerca e audiolibro.",
    importBookError: "Importazione non riuscita",
    playerSeek: "Avanzamento",
    playerBack10: "Indietro di 10 secondi",
    playerForward10: "Avanti di 10 secondi",
    playerSpeed: "Velocita di riproduzione",
    playerVolume: "Volume",
    audiobookChapters: "Capitoli",
    audiobookChapterCount: "{{count}} capitoli",
    audiobookAutoAdvance: "Avanzamento automatico",
    audiobookFigures: "Figure e grafici",
    audiobookAudioPending: "Generazione",
    audiobookSelectChapter: "Seleziona un capitolo da riprodurre",
    audiobookPrevChapter: "Capitolo precedente",
    audiobookNextChapter: "Capitolo successivo",
    audiobookPlay: "Riproduci",
    audiobookPause: "Pausa",
  ...
  mentor: {
    title: "Consulta il tuo Mentore",
    subtitle: "Confrontati su documenti, lavoro e carriera con un mentore che ha letto tutta la tua libreria.",
    placeholder: "Chiedi al tuo mentore… (⌘Invio per inviare)",
    send: "Invia",
    thinking: "Sto pensando…",
    memoryButton: "Memorie",
    memoryTitle: "Consulenze passate",
    memoryEmpty: "Nessuna memoria ancora. Il mentore ricorda l'essenziale di ogni consulenza.",
    memoryDelete: "Elimina memoria",
    memoryDeleteError: "Eliminazione della memoria non riuscita",
    retry: "Riprova",
    speak: "Leggi ad alta voce",
    speakError: "Generazione audio non riuscita",
    consultError: "Il mentore non è riuscito a rispondere. Riprova.",
    sampleQuestion1: "Vorrei un confronto sulla struttura della mia proposta al cliente",
    sampleQuestion2: "Come comunicare un report di avanzamento difficile?",
    sampleQuestion3: "Su cosa dovrei concentrarmi per crescere nei prossimi sei mesi?",
    tabChat: "Consulta",
    tabSlides: "Slide",
    tabWeights: "Pesi di apprendimento",
    weightSaved: "Peso salvato",
    weightSaveError: "Salvataggio del peso non riuscito",
    weightsEmpty: "Nessun libro. Importa prima un libro.",
    weightsHelp: "Regola quanto il mentore si basa su ciascun libro (0 lo esclude). Il badge ×N è il rinforzo automatico dalle consulenze recenti.",
    weightBook: "Peso del libro",
    weightChapter: "Peso del capitolo",
    weightChapters: "Pesi dei capitoli",
    weightExcluded: "Escluso dal richiamo",
    weightAutoHint: "Rinforzo automatico dalle consulenze recenti",
    slideDropzone: "Carica un deck da revisionare (png / jpg / pdf / pptx)",
    slideReviewing: "Il mentore sta revisionando le tue slide…",
    slideReviewError: "Revisione delle slide non riuscita. Riprova.",
    slideHistory: "Revisioni precedenti",
    gatePassed: "Soglia di qualità superata",
    gateFailed: "Sotto la soglia di qualità ({{threshold}})",
    topFix: "Correggi prima questo",
    axis_logic: "Logica e struttura argomentativa",
    axis_message_body: "Coerenza messaggio–corpo",
    axis_charts: "Tabelle e grafici",
    axis_tone_manner: "Tono e coerenza",
    axis_design: "Design",
    applySelect: "Seleziona la correzione",
    ...
    personaSave: "Salva",
    personaActivate: "Passa a questa persona",
    personaActivated: "Persona cambiata",
