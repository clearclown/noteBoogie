...
export const ruRU = {
  ...
  searchPage: {
    ...
    askScope: "Область поиска",
    askScopeAll: "Вся библиотека",
  ...
  podcasts: {
    ...
    audiobookGenerateTitle: "Создать аудиокнигу",
    audiobookGenerateDesc: "Выберите импортированную книгу (источник) и запустите генерацию аудио по главам.",
    audiobookSourceLabel: "Книга (источник)",
    audiobookNameLabel: "Название аудиокниги",
    audiobookGenerateStart: "Начать генерацию",
    ...
    importBook: "Добавить книгу",
    importBookTitle: "Добавить книгу (PDF)",
    importBookDesc: "Загрузите PDF отсканированной книги: OCR (поддержка вертикального японского), подписи к рисункам и эмбеддинги — ~30 мин на 400 страниц.",
    importBookFile: "PDF-файл",
    importBookName: "Название (необязательно)",
    importBookCaptions: "Создать подписи к рисункам (vision)",
    importBookStart: "Начать импорт",
    importBookRunning: "Конвертация и импорт… можно закрыть страницу, сервер продолжит.",
    importBookDone: "Книга импортирована. Доступна для поиска и аудиокниги.",
    importBookError: "Импорт не удался",
    playerSeek: "Перемотка",
    playerBack10: "Назад на 10 секунд",
    playerForward10: "Вперёд на 10 секунд",
    ...
    audiobookFigures: "Рисунки и графики",
    audiobookAudioPending: "Создаётся",
    audiobookSelectChapter: "Выберите главу для воспроизведения",
    audiobookPrevChapter: "Предыдущая глава",
    audiobookNextChapter: "Следующая глава",
    audiobookPlay: "Воспроизвести",
    audiobookPause: "Пауза",
  ...
  mentor: {
    title: "Совет наставника",
    subtitle: "Обсуждайте документы, работу и карьеру с наставником, прочитавшим всю вашу библиотеку.",
    placeholder: "Задайте вопрос наставнику… (⌘Enter — отправить)",
    send: "Отправить",
    thinking: "Думаю…",
    memoryButton: "Память",
    memoryTitle: "Прошлые консультации",
    memoryEmpty: "Пока нет записей. Наставник запоминает суть каждой консультации.",
    memoryDelete: "Удалить запись",
    memoryDeleteError: "Не удалось удалить запись",
    retry: "Повторить",
    speak: "Озвучить",
    speakError: "Не удалось создать аудио",
    consultError: "Наставник не смог ответить. Попробуйте ещё раз.",
    sampleQuestion1: "Хочу обсудить структуру предложения для клиента",
    sampleQuestion2: "Как сообщить о сложном статусе проекта?",
    sampleQuestion3: "На чём сосредоточиться, чтобы вырасти за полгода?",
    tabChat: "Консультация",
    tabSlides: "Слайды",
    tabWeights: "Веса обучения",
    weightSaved: "Вес сохранён",
    weightSaveError: "Не удалось сохранить вес",
    weightsEmpty: "Книг пока нет. Сначала импортируйте книгу.",
    weightsHelp: "Настройте, насколько наставник опирается на каждую книгу (0 — исключить). Значок ×N — автоматическое усиление по недавним консультациям.",
    weightBook: "Вес книги",
    weightChapter: "Вес главы",
    weightChapters: "Веса глав",
    weightExcluded: "Исключено из поиска",
    weightAutoHint: "Автоматическое усиление по недавним консультациям",
    slideDropzone: "Загрузите слайды на разбор (png / jpg / pdf / pptx)",
    slideReviewing: "Наставник разбирает ваши слайды…",
    slideReviewError: "Не удалось разобрать слайды. Попробуйте ещё раз.",
    slideHistory: "Прошлые разборы",
    gatePassed: "Порог качества пройден",
    gateFailed: "Ниже порога качества ({{threshold}})",
    topFix: "Исправьте в первую очередь",
    axis_logic: "Логика и структура аргументации",
    axis_message_body: "Соответствие заголовка и содержания",
    axis_charts: "Таблицы и графики",
    axis_tone_manner: "Тон и единообразие",
    axis_design: "Дизайн",
    applySelect: "Выбрать исправление",
    ...
    personaButton: "Персона",
    personaTitle: "Персона наставника",
    personaHelp: "Наставник не привязан к профессии. Опишите, кто он (консультант, хирург, редактор, шеф-повар…) под вашу библиотеку — сразу действует в консультациях и разборе слайдов.",
    personaPlaceholder: "напр.: Вы опытный главный редактор, наставляющий пользователя в письме…",
    personaSave: "Сохранить",
    personaActivate: "Переключиться на эту персону",
    personaActivated: "Персона переключена",
    personaSaved: "Персона сохранена",
    personaError: "Не удалось сохранить персону",
  },
