...
export const bnIN = {
  ...
  podcasts: {
    audiobookScriptProfile: "স্ক্রিপ্ট মডেল (প্রোফাইল)",
    audiobookVoiceProfile: "কণ্ঠ (প্রোফাইল)",
    ...
    audiobookGenerateDesc: "একটি আমদানি করা বই (উৎস) বেছে নিন এবং অধ্যায় অনুযায়ী অডিও তৈরি শুরু করুন।",
    audiobookSourceLabel: "বই (উৎস)",
    audiobookNameLabel: "অডিওবুকের নাম",
    audiobookGenerateStart: "তৈরি শুরু করুন",
    ...
    importBook: "বই যোগ করুন",
    importBookTitle: "বই যোগ করুন (PDF)",
    importBookDesc: "স্ক্যান করা বইয়ের PDF আপলোড করুন: OCR রূপান্তর, চিত্রের ক্যাপশন ও এমবেডিং — ৪০০ পৃষ্ঠায় ~৩০ মিনিট।",
    importBookFile: "PDF ফাইল",
    importBookName: "শিরোনাম (ঐচ্ছিক)",
    importBookCaptions: "চিত্রের ক্যাপশন তৈরি করুন (vision)",
    importBookStart: "ইমপোর্ট শুরু",
    importBookRunning: "রূপান্তর চলছে… পৃষ্ঠা বন্ধ করলেও সার্ভারে কাজ চলবে।",
    importBookDone: "বই ইমপোর্ট সম্পন্ন।",
    importBookError: "ইমপোর্ট ব্যর্থ",
    playerSeek: "সিক",
    playerBack10: "১০ সেকেন্ড পিছনে",
    playerForward10: "১০ সেকেন্ড সামনে",
    playerSpeed: "প্লেব্যাক গতি",
    playerVolume: "ভলিউম",
    audiobookChapters: "অধ্যায়",
    audiobookChapterCount: "{{count}}টি অধ্যায়",
    audiobookAutoAdvance: "স্বয়ংক্রিয় পরবর্তী",
    audiobookFigures: "চিত্র ও গ্রাফ",
    audiobookAudioPending: "তৈরি হচ্ছে",
    audiobookSelectChapter: "চালানোর জন্য একটি অধ্যায় নির্বাচন করুন",
    audiobookPrevChapter: "আগের অধ্যায়",
    audiobookNextChapter: "পরের অধ্যায়",
    audiobookPlay: "চালান",
    audiobookPause: "বিরতি",
  ...
  mentor: {
    title: "মেন্টরের পরামর্শ নিন",
    subtitle: "আপনার পুরো লাইব্রেরি পড়া একজন মেন্টরের সঙ্গে নথি, কাজ ও ক্যারিয়ার নিয়ে আলোচনা করুন।",
    placeholder: "মেন্টরকে জিজ্ঞাসা করুন… (⌘Enter পাঠাতে)",
    send: "পাঠান",
    thinking: "ভাবছি…",
    memoryButton: "স্মৃতি",
    memoryTitle: "আগের পরামর্শ",
    memoryEmpty: "এখনও কোনো স্মৃতি নেই। প্রতিটি পরামর্শের সারমর্ম মেন্টর মনে রাখে।",
    memoryDelete: "স্মৃতি মুছুন",
    memoryDeleteError: "স্মৃতি মুছতে ব্যর্থ",
    retry: "আবার চেষ্টা করুন",
    speak: "পড়ে শোনান",
    speakError: "অডিও তৈরি করতে ব্যর্থ",
    consultError: "মেন্টর উত্তর দিতে পারেননি। আবার চেষ্টা করুন।",
    sampleQuestion1: "ক্লায়েন্ট প্রস্তাবের কাঠামো নিয়ে মতামত চাই",
    sampleQuestion2: "কঠিন অগ্রগতি প্রতিবেদন কীভাবে জানাব?",
    sampleQuestion3: "আগামী ছয় মাসে কীসে মনোযোগ দেওয়া উচিত?",
    tabChat: "পরামর্শ",
    tabSlides: "স্লাইড",
    tabWeights: "শেখার ওজন",
    weightSaved: "ওজন সংরক্ষিত",
    weightSaveError: "ওজন সংরক্ষণে ব্যর্থ",
    weightsEmpty: "এখনও কোনো বই নেই। আগে একটি বই যোগ করুন।",
    weightsHelp: "মেন্টর প্রতিটি বইকে কতটা গুরুত্ব দেবে তা ঠিক করুন (0 বাদ দেয়)। ×N ব্যাজটি সাম্প্রতিক পরামর্শ থেকে স্বয়ংক্রিয় বাড়তি গুরুত্ব।",
    weightBook: "বইয়ের ওজন",
    weightChapter: "অধ্যায়ের ওজন",
    weightChapters: "অধ্যায়ের ওজন",
    weightExcluded: "অনুসন্ধান থেকে বাদ",
    weightAutoHint: "সাম্প্রতিক পরামর্শ থেকে স্বয়ংক্রিয় গুরুত্ব",
    slideDropzone: "পর্যালোচনার জন্য স্লাইড আপলোড করুন (png / jpg / pdf / pptx)",
    slideReviewing: "মেন্টর আপনার স্লাইড পর্যালোচনা করছেন…",
    slideReviewError: "স্লাইড পর্যালোচনা ব্যর্থ। আবার চেষ্টা করুন।",
    slideHistory: "আগের পর্যালোচনা",
    gatePassed: "মান নিয়ন্ত্রণ উত্তীর্ণ",
    gateFailed: "মান নিয়ন্ত্রণে অনুত্তীর্ণ ({{threshold}})",
    topFix: "আগে এটি ঠিক করুন",
    axis_logic: "যুক্তি ও কাঠামো",
    axis_message_body: "শিরোনাম–বডি সামঞ্জস্য",
    axis_charts: "টেবিল ও চার্ট",
    axis_tone_manner: "টোন ও ধারাবাহিকতা",
    axis_design: "ডিজাইন",
    applySelect: "প্রয়োগের জন্য নির্বাচন করুন",
    ...
    personaButton: "পারসোনা",
    personaTitle: "মেন্টরের পারসোনা",
    personaHelp: "মেন্টর কোনো নির্দিষ্ট পেশায় সীমাবদ্ধ নয়। আপনার লাইব্রেরি অনুযায়ী বর্ণনা করুন (কনসালট্যান্ট, সার্জন, সম্পাদক, শেফ…) — পরামর্শ ও স্লাইড পর্যালোচনায় সঙ্গে সঙ্গে প্রযোজ্য।",
    personaPlaceholder: "যেমন: আপনি একজন অভিজ্ঞ প্রধান সম্পাদক, ব্যবহারকারীর লেখা উন্নত করছেন…",
    personaSave: "সংরক্ষণ",
    personaActivate: "এই পারসোনায় যান",
    personaActivated: "পারসোনা পরিবর্তিত",
    personaSaved: "পারসোনা সংরক্ষিত",
    personaError: "পারসোনা সংরক্ষণে ব্যর্থ",
  },
