...
export const jaJP = {
  ...
  podcasts: {
    ...
    audiobookGenerateTitle: "オーディオブックを生成",
    audiobookGenerateDesc: "取り込み済みの本（ソース）を選び、章ごとの音声生成を開始します。",
    audiobookSourceLabel: "本（ソース）",
    audiobookNameLabel: "オーディオブック名",
    audiobookGenerateStart: "生成開始",
    ...
    importBook: "本を追加",
    importBookTitle: "本を追加（PDF）",
    importBookDesc: "スキャンした本のPDFをアップロードすると、OCR変換（縦書き対応）→ 図キャプション → 埋め込みまで自動で行います（400頁で30分前後）。",
    importBookFile: "PDFファイル",
    importBookName: "本のタイトル（任意）",
    importBookCaptions: "図のキャプションを生成（vision）",
    importBookStart: "取り込み開始",
    importBookRunning: "変換・取り込み中… この画面を閉じてもサーバー側で処理は続きます。",
    importBookDone: "取り込み完了。検索・相談・オーディオブック生成に使えます。",
    importBookError: "取り込みに失敗しました",
    playerSeek: "シーク",
    playerBack10: "10秒戻る",
    playerForward10: "10秒進む",
    playerSpeed: "再生速度",
    playerVolume: "音量",
    audiobookChapters: "チャプター",
    audiobookChapterCount: "全{{count}}章",
    audiobookAutoAdvance: "連続再生",
    audiobookFigures: "図・グラフ",
    audiobookAudioPending: "生成中",
    audiobookSelectChapter: "再生する章を選択してください",
    audiobookPrevChapter: "前の章",
    audiobookNextChapter: "次の章",
    audiobookPlay: "再生",
    audiobookPause: "一時停止",
  ...
  mentor: {
    title: "師匠に相談",
    subtitle: "蔵書を読み込んだ師匠と、資料の壁打ち・仕事の進め方・キャリアを相談できます。",
    placeholder: "相談を入力…（⌘Enter で送信）",
    send: "送信",
    thinking: "考え中…",
    memoryButton: "記憶",
    memoryTitle: "過去の相談",
    memoryEmpty: "まだ記憶がありません。相談すると要点を覚えていきます。",
    memoryDelete: "記憶を削除",
    memoryDeleteError: "記憶の削除に失敗しました",
    retry: "再送",
    speak: "読み上げ",
    speakError: "音声の生成に失敗しました",
    consultError: "師匠が応答できませんでした。もう一度お試しください。",
    sampleQuestion1: "クライアント初回提案の構成を壁打ちしたい",
    sampleQuestion2: "言いにくい進捗報告の伝え方を相談したい",
    sampleQuestion3: "今後半年で何を伸ばすべきか相談したい",
    tabChat: "相談",
    tabSlides: "スライド",
    tabWeights: "学習の傾斜",
    weightSaved: "傾斜を保存しました",
    weightSaveError: "傾斜の保存に失敗しました",
    weightsEmpty: "蔵書がありません。先に本を取り込んでください。",
    weightsHelp: "師匠が各本をどれだけ重く参照するかを調整します（0 で除外）。×N バッジは最近の相談から付く自動傾斜です。",
    weightBook: "本の傾斜",
    weightChapter: "章の傾斜",
    weightChapters: "章の傾斜",
    weightExcluded: "参照から除外中",
    weightAutoHint: "最近の相談による自動傾斜",
    slideDropzone: "レビューするスライドをアップロード（png / jpg / pdf / pptx）",
    slideReviewing: "師匠がスライドをレビュー中…",
    slideReviewError: "スライドレビューに失敗しました。もう一度お試しください。",
    slideHistory: "過去のレビュー",
    gatePassed: "品質ゲート通過",
    gateFailed: "品質ゲート未達（{{threshold}}）",
    topFix: "最優先の直し",
    axis_logic: "論理整理・論点整理",
    axis_message_body: "メッセージ×ボディ整合",
    axis_charts: "表・グラフの整理",
    axis_tone_manner: "トンマナ",
    axis_design: "デザイン",
    applySelect: "適用する修正を選択",
    ...
    personaSave: "保存",
    personaActivate: "このペルソナに切り替え",
    personaActivated: "ペルソナを切り替えました",
