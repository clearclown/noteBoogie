...
export const frFR = {
  ...
  searchPage: {
    ...
    askScope: "Portée de la recherche",
    askScopeAll: "Toute la bibliothèque",
  ...
  podcasts: {
    audiobookScriptProfile: "Modèle du script (profil)",
    audiobookVoiceProfile: "Voix (profil)",
    ...
    audiobookGenerateDesc: "Choisissez un livre importé (source) et lancez la génération audio par chapitre.",
    audiobookSourceLabel: "Livre (source)",
    audiobookNameLabel: "Nom du livre audio",
    audiobookGenerateStart: "Lancer la génération",
    ...
    importBook: "Ajouter un livre",
    importBookTitle: "Ajouter un livre (PDF)",
    importBookDesc: "Televersez le PDF d'un livre scanne : OCR (japonais vertical pris en charge), legendes des figures et embeddings - ~30 min pour 400 pages.",
    importBookFile: "Fichier PDF",
    importBookName: "Titre (facultatif)",
    importBookCaptions: "Generer les legendes des figures (vision)",
    importBookStart: "Lancer l'import",
    importBookRunning: "Conversion et ingestion... vous pouvez fermer ; le serveur continue.",
    importBookDone: "Livre importe. Pret pour la recherche et le livre audio.",
    importBookError: "Echec de l'import",
    playerSeek: "Position",
    playerBack10: "Reculer de 10 secondes",
    ...
    audiobookFigures: "Figures et graphiques",
    audiobookAudioPending: "Génération",
    audiobookSelectChapter: "Sélectionnez un chapitre à lire",
    audiobookPrevChapter: "Chapitre précédent",
    audiobookNextChapter: "Chapitre suivant",
    audiobookPlay: "Lecture",
    audiobookPause: "Pause",
  ...
  mentor: {
    title: "Consultez votre mentor",
    subtitle: "Échangez sur vos documents, votre travail et votre carrière avec un mentor qui a lu toute votre bibliothèque.",
    placeholder: "Posez votre question… (⌘Entrée pour envoyer)",
    send: "Envoyer",
    thinking: "Réflexion…",
    memoryButton: "Mémoires",
    memoryTitle: "Consultations passées",
    memoryEmpty: "Aucune mémoire pour l'instant. Le mentor retient l'essentiel de chaque consultation.",
    memoryDelete: "Supprimer la mémoire",
    memoryDeleteError: "Échec de la suppression de la mémoire",
    retry: "Réessayer",
    speak: "Lire à voix haute",
    speakError: "Échec de la génération audio",
    consultError: "Le mentor n'a pas pu répondre. Veuillez réessayer.",
    sampleQuestion1: "J'aimerais un avis sur la structure de ma proposition client",
    sampleQuestion2: "Comment annoncer un rapport d'avancement délicat ?",
    sampleQuestion3: "Sur quoi me concentrer pour progresser ces six prochains mois ?",
    tabChat: "Consulter",
    tabSlides: "Diapositives",
    tabWeights: "Pondération",
    weightSaved: "Pondération enregistrée",
    weightSaveError: "Échec de l'enregistrement de la pondération",
    weightsEmpty: "Aucun livre. Importez d'abord un livre.",
    weightsHelp: "Réglez l'importance de chaque livre pour le mentor (0 l'exclut). Le badge ×N est le renforcement automatique issu des consultations récentes.",
    weightBook: "Pondération du livre",
    weightChapter: "Pondération du chapitre",
    weightChapters: "Pondération des chapitres",
    weightExcluded: "Exclu du rappel",
    weightAutoHint: "Renforcement automatique des consultations récentes",
    slideDropzone: "Déposez un deck à relire (png / jpg / pdf / pptx)",
    slideReviewing: "Le mentor relit vos diapositives…",
    slideReviewError: "Échec de la relecture. Veuillez réessayer.",
    slideHistory: "Relectures passées",
    gatePassed: "Seuil de qualité atteint",
    gateFailed: "Sous le seuil de qualité ({{threshold}})",
    topFix: "À corriger en priorité",
    axis_logic: "Logique et structure d'argumentation",
    axis_message_body: "Cohérence message–corps",
    axis_charts: "Tableaux et graphiques",
    axis_tone_manner: "Ton et cohérence",
    axis_design: "Design",
    applySelect: "Sélectionner la correction",
    ...
    personaActivate: "Passer à cette persona",
    personaActivated: "Persona changée",
