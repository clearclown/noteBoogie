...
export const zhCN = {
  ...
  podcasts: {
    audiobookScriptProfile: "脚本模型（配置）",
    audiobookVoiceProfile: "语音（配置）",
    audiobookRetry: "重试",
    audiobookFailed: "失败",
    audiobookGenerate: "生成有声书",
    audiobookGenerateTitle: "生成有声书",
    audiobookGenerateDesc: "选择已导入的书籍（来源）并开始按章节生成音频。",
    audiobookSourceLabel: "书籍（来源）",
    audiobookNameLabel: "有声书名称",
    audiobookGenerateStart: "开始生成",
    ...
    importBook: "添加书籍",
    importBookTitle: "添加书籍（PDF）",
    importBookDesc: "上传扫描书籍PDF，自动进行OCR转换（支持竖排日文）、图片说明与向量化（400页约30分钟）。",
    importBookFile: "PDF文件",
    importBookName: "书名（可选）",
    importBookCaptions: "生成图片说明（vision）",
    importBookStart: "开始导入",
    importBookRunning: "转换和导入中… 关闭此页面后服务器仍会继续处理。",
    importBookDone: "导入完成。可用于搜索、咨询和有声书生成。",
    importBookError: "导入失败",
    playerSeek: "进度",
    playerBack10: "后退10秒",
    playerForward10: "前进10秒",
    playerSpeed: "播放速度",
    playerVolume: "音量",
    ...
    audiobookSelectChapter: "请选择要播放的章节",
  ...
  mentor: {
    title: "向导师请教",
    subtitle: "与读遍你整个书库的导师讨论资料、工作方式和职业发展。",
    placeholder: "输入你的问题…（⌘Enter 发送）",
    send: "发送",
    thinking: "思考中…",
    memoryButton: "记忆",
    memoryTitle: "过往咨询",
    memoryEmpty: "还没有记忆。每次咨询后导师会记住要点。",
    memoryDelete: "删除记忆",
    memoryDeleteError: "删除记忆失败",
    retry: "重试",
    speak: "朗读",
    speakError: "生成语音失败",
    consultError: "导师无法回答，请重试。",
    sampleQuestion1: "想讨论客户提案的结构",
    sampleQuestion2: "如何传达一份不太好开口的进度报告？",
    sampleQuestion3: "未来半年我应该重点提升什么？",
    tabChat: "咨询",
    tabSlides: "幻灯片",
    tabWeights: "学习权重",
    weightSaved: "权重已保存",
    weightSaveError: "保存权重失败",
    weightsEmpty: "书库为空。请先导入书籍。",
    weightsHelp: "调整导师参考每本书的程度（0 为排除）。×N 徽章是根据近期咨询自动加权的结果。",
    weightBook: "书籍权重",
    weightChapter: "章节权重",
    weightChapters: "章节权重",
    weightExcluded: "已从检索中排除",
    weightAutoHint: "根据近期咨询的自动加权",
    slideDropzone: "上传要点评的幻灯片（png / jpg / pdf / pptx）",
    slideReviewing: "导师正在点评你的幻灯片…",
    slideReviewError: "幻灯片点评失败，请重试。",
    slideHistory: "历史点评",
    gatePassed: "通过质量门槛",
    gateFailed: "未达质量门槛（{{threshold}}）",
    topFix: "优先修改",
    axis_logic: "逻辑与论点结构",
    axis_message_body: "标题与正文一致性",
    axis_charts: "表格与图表",
    axis_tone_manner: "风格统一",
    axis_design: "设计",
    applySelect: "选择要应用的修改",
    ...
    personaSave: "保存",
    personaActivate: "切换到此角色",
    personaActivated: "已切换角色",
    personaSaved: "角色已保存",
    personaError: "保存角色失败",
  },
