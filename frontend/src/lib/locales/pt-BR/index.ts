...
export const ptBR = {
  ...
  podcasts: {
    audiobookScriptProfile: "Modelo do roteiro (perfil)",
    ...
    audiobookGenerateDesc: "Escolha um livro importado (fonte) e inicie a geração de áudio por capítulo.",
    audiobookSourceLabel: "Livro (fonte)",
    audiobookNameLabel: "Nome do audiolivro",
    audiobookGenerateStart: "Iniciar geração",
    audiobookGenerateError: "Falha ao iniciar a geração. O gateway está em execução?",
    audiobooksTab: "Audiolivros",
    audiobooksEmpty: "Ainda não há audiolivros. Converta um livro e gere um com `make ingest-book`.",
    chapterFeedbackUp: "Capítulo bom",
    chapterFeedbackDown: "Capítulo fraco",
    importBook: "Adicionar livro",
    importBookTitle: "Adicionar livro (PDF)",
    importBookDesc: "Envie o PDF de um livro escaneado. Ele e convertido com OCR (japones vertical suportado) e ingerido com legendas e embeddings - ~30 min para 400 paginas.",
    importBookFile: "Arquivo PDF",
    importBookName: "Titulo (opcional)",
    importBookCaptions: "Gerar legendas de figuras (vision)",
    importBookStart: "Iniciar importacao",
    importBookRunning: "Convertendo e ingerindo... voce pode fechar; o servidor continua.",
    importBookDone: "Livro importado. Pronto para busca e audiolivro.",
    importBookError: "Falha na importacao",
    playerSeek: "Buscar",
    playerBack10: "Voltar 10 segundos",
    playerForward10: "Avancar 10 segundos",
    playerSpeed: "Velocidade de reproducao",
    playerVolume: "Volume",
    audiobookChapters: "Capítulos",
    audiobookChapterCount: "{{count}} capítulos",
    audiobookAutoAdvance: "Avanço automático",
    audiobookFigures: "Figuras e gráficos",
    audiobookAudioPending: "Gerando",
    audiobookSelectChapter: "Selecione um capítulo para reproduzir",
    audiobookPrevChapter: "Capítulo anterior",
    audiobookNextChapter: "Próximo capítulo",
    audiobookPlay: "Reproduzir",
    audiobookPause: "Pausar",
  ...
  mentor: {
    title: "Consulte seu Mentor",
    subtitle: "Converse sobre seus materiais, trabalho e carreira com um mentor que leu toda a sua biblioteca.",
    placeholder: "Pergunte ao seu mentor… (⌘Enter para enviar)",
    send: "Enviar",
    thinking: "Pensando…",
    memoryButton: "Memórias",
    memoryTitle: "Consultas anteriores",
    memoryEmpty: "Ainda não há memórias. O mentor guarda o essencial de cada consulta.",
    memoryDelete: "Excluir memória",
    memoryDeleteError: "Falha ao excluir a memória",
    retry: "Tentar novamente",
    speak: "Ouvir",
    speakError: "Falha ao gerar o áudio",
    consultError: "O mentor não conseguiu responder. Tente novamente.",
    sampleQuestion1: "Quero revisar a estrutura da minha proposta para o cliente",
    sampleQuestion2: "Como comunicar um relatório de progresso difícil?",
    sampleQuestion3: "No que devo focar para crescer nos próximos seis meses?",
    tabChat: "Consultar",
    tabSlides: "Slides",
    tabWeights: "Pesos de aprendizado",
    weightSaved: "Peso salvo",
    weightSaveError: "Falha ao salvar o peso",
    weightsEmpty: "Nenhum livro ainda. Importe um livro primeiro.",
    weightsHelp: "Ajuste o quanto o mentor se apoia em cada livro (0 exclui). O selo ×N é o reforço automático das consultas recentes.",
    weightBook: "Peso do livro",
    weightChapter: "Peso do capítulo",
    weightChapters: "Pesos dos capítulos",
    weightExcluded: "Excluído da consulta",
    weightAutoHint: "Reforço automático das consultas recentes",
    slideDropzone: "Envie um deck para revisar (png / jpg / pdf / pptx)",
    slideReviewing: "O mentor está revisando seus slides…",
    slideReviewError: "Falha na revisão dos slides. Tente novamente.",
    slideHistory: "Revisões anteriores",
    gatePassed: "Aprovado no gate de qualidade",
    gateFailed: "Abaixo do gate de qualidade ({{threshold}})",
    topFix: "Corrija isto primeiro",
    axis_logic: "Lógica e estrutura de argumento",
    axis_message_body: "Alinhamento mensagem–corpo",
    axis_charts: "Tabelas e gráficos",
    axis_tone_manner: "Tom e consistência",
    axis_design: "Design",
    applySelect: "Selecionar correção",
    applyFixes: "Aplicar {{count}} correções e baixar",
    applyDone: "Deck corrigido baixado",
    applyError: "Não foi possível aplicar as correções",
    discussReview: "Discutir com o mentor",
    discussPrefill: "Quero aprofundar a revisão de “{{filename}}” (nota geral {{overall}}/5). A correção prioritária é “{{fix}}” — por onde começo?",
    personaButton: "Persona",
    personaTitle: "Persona do mentor",
    personaHelp: "O mentor não é preso a uma profissão. Descreva quem ele é (consultor, cirurgião, editor, chef…) conforme sua biblioteca — vale para consultas e revisões de slides imediatamente.",
    personaPlaceholder: "ex.: Você é um editor-chefe experiente orientando a escrita do usuário…",
    personaSave: "Salvar",
    personaActivate: "Mudar para esta persona",
    personaActivated: "Persona alterada",
    personaSaved: "Persona salva",
    personaError: "Falha ao salvar a persona",
  },
